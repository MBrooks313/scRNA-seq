...
cr_import <- function(files, expt_nm, bus_filt=TRUE, min.cells=5, min.features=200, max.mt=20, dX=TRUE, dF=TRUE, dub_exp=0.075, dub_counts="decontXcounts", helper_dir="../src/data", out_dir="../data/processed", gtf){
  
  
  ##########################
  # This was written in Nov 22nd, 2022 by MJB
  # USAGE: cr_import(run_info_files, expt_nm, bus_filt = TRUE, min.cell = 5, min.features = 200, max.mt = 20, helper_dir = "../src/data", out_dir = "../data/processed")
  #
